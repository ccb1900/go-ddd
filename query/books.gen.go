...
type IBookDo interface {
	...
	FilterWithNameAndRole(name int) (result []domain.Book, err error)
}

// SELECT * FROM @@table WHERE PKEY = @name
func (b bookDo) FilterWithNameAndRole(name int) (result []domain.Book, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM Books WHERE PKEY = ? ")
