...
func (d *CreateBookResponse) FromAddBookDtoResponse(x application.AddBookDtoResponse) {
	d.ID = x.ID
}
...
func (d *CreateBookRequest) ToAddRequest() *application.AddBookDtoRequest {
	return &application.AddBookDtoRequest{}
}
